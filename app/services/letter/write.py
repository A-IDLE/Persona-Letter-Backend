...
from .generate import verfiy_language, refining_retrieved_info, generate_questions, generate_questions_test, refining_retrieved_info_test
...
def write_letter_update(letter_send: Letter, letter_config = None) -> Letter:
    ...
    related_letters = retrieve_through_letter_update(letter_content, user_id, character_id)
...
def write_letter_test(letter_send: Letter, test: RagTestData):
    ...
    generated_questions = generate_questions_test(letter_content, test.generate_questions_prompts)
    ...
    refined_retrieved_info = refining_retrieved_info_test(related_letters_str, test.refining_retrieved_info_prompt)
